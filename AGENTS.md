...
├── userland/common/          # User-space minilibc replacement (crt0 + syscall wrappers)
│   ├── minilibc.h            # minilibc API (syscall wrappers + utility declarations)
│   ├── minilibc.c            # minilibc implementation
│   └── crt0.c                # minimal `_start` and argc/argv/envp bootstrap
├── userland/hello/
